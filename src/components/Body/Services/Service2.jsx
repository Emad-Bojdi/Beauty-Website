    ...
    return (
      <>
        <div className="w-full h-auto ">
          <div className={`w-full h-auto flex flex-row justify-center relative"`}>
            <div className="w-2/5 h-full flex flex-col items-start mt-16">
              <div className="w-4/5 flex flex-col items-center border-b border-b-color5 border-opacity-30 mt-6">
            ...
            <div className="absolute w-full h-full">
                <div className="w-12 h-12 absolute right-[733px] top-0 bg-color2"></div>
              </div>
            <div className="w-2/5 h-auto ">
              <img src={src} alt="" className="w-full h-auto shadow-[5px_5px_50px_5px_rgba(0,0,0,0.3)]" />
            </div>
          </div>
        </div>
      </>
